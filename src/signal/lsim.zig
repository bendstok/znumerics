...
/// See dlsimFn for x0 and the errors.
pub fn dlsim(alloc: std.mem.Allocator, ss: StateSpace, u: []const f64, x0: ?Vec) (LsimError || std.mem.Allocator.Error)!LsimResult {
    const S = struct {
    ...
    return dlsimFn(alloc, ss, u.len, u, S.at, x0);
}
...
pub fn lsimFn(
    ...
    return dlsimFn(alloc, ssd, n_steps, ctx, u, x0);
}
...
pub fn lsim(
    ...
    return lsimFn(alloc, ss, dt, u.len, u, S.at, x0);
}
